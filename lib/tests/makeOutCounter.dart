...
import 'package:flutter_application_1/inheritedWidget_1.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  MyCounter aa = const MyCounter(title: "mattene");
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            aa,
            const MyCounter(title: "mattene"),
          ],
        ),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: aa.incrementCounter, // _incrementCounter,
        tooltip: 'Increment',
